...
class CreateRatingDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { rating: { required: true, type: () => Number }, created_by: { required: true, type: () => String }, station: { required: true, type: () => String }, comment: { required: true, type: () => Number } };
    }
}
__decorate([
...
], CreateRatingDto.prototype, "created_by", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    __metadata("design:type", String)
], CreateRatingDto.prototype, "station", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
